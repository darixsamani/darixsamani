...
Passionate about building optimized solutions with **Python**, **TypeScript**, **Rust**, and **SQL**, using frameworks like **FastAPI**, **React.js**, **Flutter**, **Salvo**,  and **NestJS**. I work across **AI/ML**, **IoT**, **Embedded Systems (FPGA)**, and **Cloud Computing**, with strong DevOps and Agile practices.
<!--
