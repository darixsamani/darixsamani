...
Passionate about building optimized solutions with **Python**, **JavaScript**/**TypeScript**, **Rust**, **Dart**, **SQL**, and  **NoSQL**(**MongoDB**, **Neo4j**, and **Redis**) using frameworks like **FastAPI**, **React.js**, **Flutter**, **Dioxus**, **Salvo**,  and **NestJS**. I work across **AI/ML**, **IoT**, **Embedded Systems (FPGA)**, and **Cloud Computing**, with strong DevOps and Agile practices.
<!--
